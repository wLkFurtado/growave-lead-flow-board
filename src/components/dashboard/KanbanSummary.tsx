...
export const KanbanSummary = ({ leadsData }: KanbanSummaryProps) => {
  ...
  return (
    <div className="bg-slate-800/30 backdrop-blur-lg border border-slate-700 rounded-xl p-6">
      <h3 className="text-xl font-bold text-white mb-4 text-center">Resumo da Jornada do Lead</h3>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-blue-500/20 border border-blue-500/50 rounded-lg p-5 text-center transition-all duration-300 hover:scale-105">
        ...
        <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-5 text-center transition-all duration-300 hover:scale-105">
        ...
        <div className="bg-emerald-500/20 border border-emerald-500/50 rounded-lg p-5 text-center transition-all duration-300 hover:scale-105">
