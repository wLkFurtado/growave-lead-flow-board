    ...
    const button = (
      <button
        ...
        className={cn(
          ...
          isActive 
            ? "bg-gradient-to-r from-[#00FF88]/20 to-[#39FF14]/20 text-[#00FF88] border border-[#00FF88]/30 shadow-lg shadow-[#00FF88]/20" 
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="growave-glass rounded-xl p-4 border border-slate-700/50 growave-card-hover">
            <div className="flex items-center space-x-3 mb-3">
              {profile && (
                <div className="w-8 h-8 bg-gradient-to-br from-[#00FF88] to-[#39FF14] rounded-full flex items-center justify-center text-white font-semibold text-sm">
